...
/**
 * CFLibReqKeyHash224 extends CFLibKeyHash224 with the appropriate behavior for the isNull() and setNull() method signatures.
 *
 * @author msobkow
 */
public class CFLibReqKeyHash224 extends CFLibKeyHash224 implements ICFLibRequired, ICFLibReqKeyHash224 {
