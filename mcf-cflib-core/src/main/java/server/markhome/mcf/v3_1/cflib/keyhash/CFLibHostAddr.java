...
/**
 * The CFLibHostAddr is a packed address for either IPV4 or IPV6 addresses, with indicators and detectors for which is which.
 * @author msobkow
 */
public final class CFLibHostAddr {
