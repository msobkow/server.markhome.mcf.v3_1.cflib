 ...
 * @author msobkow
 */
public interface ICFLibKeyHash256 {
	...
	public default int compare(ICFLibKeyHash256 h1, ICFLibKeyHash256 h2) {
		if (h1 == null) {
			if (h2 == null) {
				return 0;
			} else {
	...
	public ICFLibKeyHash256 deepClone();
  ...
  public static boolean isNull(ICFLibKeyHash256 anId) {
