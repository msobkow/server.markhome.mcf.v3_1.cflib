...
/**
 * CFLibOptKeyHash224 extends CFLibKeyHash224 with the appropriate behavior for the isNull() and setNull() method signatures.
 *
 * @author msobkow
 */
public class CFLibOptKeyHash224 extends CFLibKeyHash224 implements ICFLibOptional, ICFLibOptKeyHash224 {
