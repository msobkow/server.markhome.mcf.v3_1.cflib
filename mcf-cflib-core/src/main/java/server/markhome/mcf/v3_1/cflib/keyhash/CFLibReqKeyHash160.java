...
/**
 * CFLibReqKeyHash160 extends CFLibKeyHash160 with the appropriate behavior for the isNull() and setNull() method signatures.
 *
 * @author msobkow
 */
public class CFLibReqKeyHash160 extends CFLibKeyHash160 implements ICFLibRequired, ICFLibReqKeyHash160 {
