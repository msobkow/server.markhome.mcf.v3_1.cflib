...
/**
 * CFLibOptKeyHash512 extends CFLibKeyHash512 with the appropriate behavior for the isNull() and setNull() method signatures.
 *
 * @author msobkow
 */
public class CFLibOptKeyHash512 extends CFLibKeyHash512 implements ICFLibOptional, ICFLibOptKeyHash512 {
