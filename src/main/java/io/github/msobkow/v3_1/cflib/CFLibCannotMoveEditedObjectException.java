 ...
 */
public class CFLibCannotMoveEditedObjectException extends IllegalStateException {

	protected String localMessage = null;

	public CFLibCannotMoveEditedObjectException(
		String enMsg,
		String xMsg )
	{
		super( enMsg );
	...
	public CFLibCannotMoveEditedObjectException()
	{
		super( String.format(Inz.s("cflib.CFLibCannnotMoveEditedObjectException.default"), "").trim());
		this.localMessage = String.format(Inz.x("cflib.CFLibCannnotMoveEditedObjectException.default"), "").trim();
	}

	public CFLibCannotMoveEditedObjectException(Throwable th)
	{
		super( String.format(Inz.s("cflib.CFLibCannnotMoveEditedObjectException.default"), "").trim(), th);
		this.localMessage = String.format(Inz.x("cflib.CFLibCannnotMoveEditedObjectException.default"), "").trim();
	}
	...
	public CFLibCannotMoveEditedObjectException(
		...
		String methName)
	{
		super( String.format(Inz.s("cflib.CFLibEditAlreadyOpenException.default"),
				throwingClass.getName()	+ ( ( ( methName != null ) && !methName.isEmpty()) ? "." + methName + "()" : "" )));
		this.localMessage = String.format(Inz.x("cflib.CFLibCannnotMoveEditedObjectException.default"),
				throwingClass.getName()	+ (( methName != null && !methName.isEmpty()) ? ("." + methName + "()") : "" ));
	}
	...
	public CFLibCannotMoveEditedObjectException(
		...
		Throwable th )
	{
		super( String.format(Inz.s("cflib.CFLibCannnotMoveEditedObjectException.default"),
				throwingClass.getName()	+ ( ( ( methName != null ) && !methName.isEmpty()) ? "." + methName + "()" : "" )),
			th);
		this.localMessage = String.format(Inz.x("cflib.CFLibCannnotMoveEditedObjectException.default"),
				throwingClass.getName()	+ (( methName != null && !methName.isEmpty()) ? ("." + methName + "()") : "" ));
