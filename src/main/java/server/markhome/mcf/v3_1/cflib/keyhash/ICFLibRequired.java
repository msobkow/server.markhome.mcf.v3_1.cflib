...
/**
 * ICFLibOptional is the base interface used to specify the accessors used to manipulate optional values.
 * @author msobkow
 */
public interface ICFLibRequired {
	...
	public default void setNull() {
		throw new CFLibNullArgumentException(getClass(), "setNull", 0, "value");
	};
}
