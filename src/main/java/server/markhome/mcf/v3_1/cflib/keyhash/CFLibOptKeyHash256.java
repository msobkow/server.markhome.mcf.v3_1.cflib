...
/**
 * CFLibOptKeyHash256 extends CFLibKeyHash256 with the appropriate behavior for the isNull() and setNull() method signatures.
 *
 * @author msobkow
 */
public class CFLibOptKeyHash256 extends CFLibKeyHash256 implements ICFLibOptional, ICFLibOptKeyHash256 {
