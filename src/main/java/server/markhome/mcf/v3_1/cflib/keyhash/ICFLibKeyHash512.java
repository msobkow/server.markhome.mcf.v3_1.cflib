 ...
 * @author msobkow
 */
public interface ICFLibKeyHash512 {
	...
	public default int compare(ICFLibKeyHash512 h1, ICFLibKeyHash512 h2) {
		if (h1 == null) {
			if (h2 == null) {
				return 0;
			} else {
	...
	public ICFLibKeyHash512 deepClone();
  ...
  public static boolean isNull(ICFLibKeyHash512 anId) {
