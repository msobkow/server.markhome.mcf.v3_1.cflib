...
/**
 * CFLibOptKeyHash160 extends CFLibKeyHash160 with the appropriate behavior for the isNull() and setNull() method signatures.
 *
 * @author msobkow
 */
public class CFLibOptKeyHash160 extends CFLibKeyHash160 implements ICFLibOptional, ICFLibOptKeyHash160 {
