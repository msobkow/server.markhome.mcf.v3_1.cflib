...
/**
 * CFLibReqKeyHash256 extends CFLibKeyHash256 with the appropriate behavior for the isNull() and setNull() method signatures.
 *
 * @author msobkow
 */
public class CFLibReqKeyHash256 extends CFLibKeyHash256 implements ICFLibRequired, ICFLibReqKeyHash256 {
