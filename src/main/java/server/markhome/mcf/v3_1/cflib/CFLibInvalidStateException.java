 ...
 */
public class CFLibInvalidStateException extends CFLibArgumentException {

	// Inherited constructor patterns

	public CFLibInvalidStateException(
		String enMsg,
		String xMsg )
	{
		super(enMsg, xMsg);
...
//	}
	...
	public CFLibInvalidStateException(
		...
		String xReason )
	{
		super(String.format(Inz.s("cflib.CFLibInvalidStateException.TcmnMsg"),
				throwingClass.getName()	+ ( ( ( methName != null ) && !methName.isEmpty()) ? "." + methName + "()" : "" ),
				enReason),
			String.format(Inz.x("cflib.CFLibInvalidStateException.TcmnMsg"),
				throwingClass.getName()	+ (( methName != null && !methName.isEmpty()) ? ("." + methName + "()") : "" ),
				xReason));
	}
	...
	public CFLibInvalidStateException(
		...
		String xReason )
	{
		super(String.format(Inz.s("cflib.CFLibInvalidStateException.FldMsg"),
				enFieldName + ( ( methName != null && !methName.isEmpty()) ? "." + methName + "()"	: "" ),
				enReason),
		String.format(Inz.x("cflib.CFLibInvalidStateException.FldMsg"),
				enFieldName + ( ( methName != null && !methName.isEmpty()) ? "." + methName + "()"	: "" ),
				xReason));
	}
