 ...
 * @author msobkow
 */
public interface ICFLibKeyHash128 {
	...
	public default int compare(ICFLibKeyHash128 h1, ICFLibKeyHash128 h2) {
		if (h1 == null) {
			if (h2 == null) {
				return 0;
			} else {
	...
	public ICFLibKeyHash128 deepClone();
  ...
  public static boolean isNull(ICFLibKeyHash128 anId) {
