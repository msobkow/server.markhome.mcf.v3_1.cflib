 ...
 * @author msobkow
 */
public interface ICFLibKeyHash384 {
	...
	public default int compare(ICFLibKeyHash384 h1, ICFLibKeyHash384 h2) {
		if (h1 == null) {
			if (h2 == null) {
				return 0;
			} else {
	...
	public ICFLibKeyHash384 deepClone();
  ...
  public static boolean isNull(ICFLibKeyHash384 anId) {
