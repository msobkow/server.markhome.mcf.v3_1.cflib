...
/**
 * CFLibReqKeyHash384 extends CFLibKeyHash384 with the appropriate behavior for the isNull() and setNull() method signatures.
 *
 * @author msobkow
 */
public class CFLibReqKeyHash384 extends CFLibKeyHash384 implements ICFLibRequired, ICFLibReqKeyHash384 {
