 ...
 * @author msobkow
 */
public interface ICFLibKeyHash160 {
	...
	public default int compare(ICFLibKeyHash160 h1, ICFLibKeyHash160 h2) {
		if (h1 == null) {
			if (h2 == null) {
				return 0;
			} else {
	...
	public ICFLibKeyHash160 deepClone();
  ...
  public static boolean isNull(ICFLibKeyHash160 anId) {
