 ...
 * @author msobkow
 */
public class CFLibUuid6 implements java.io.Serializable, Comparable<CFLibUuid6>, ICFLibUuid6 {
    ...
    public static CFLibUuid6 generateUuid6() {
        ...
        CFLibHostAddr.copyAddrHeaderTo(genBytes, NODE0_START);
        // byte[] addrHeader = CFLibHostAddr.getAddrHeader(false);
