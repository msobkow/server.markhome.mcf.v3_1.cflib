...
/**
 * CFLibReqKeyHash512 extends CFLibKeyHash512 with the appropriate behavior for the isNull() and setNull() method signatures.
 *
 * @author msobkow
 */
public class CFLibReqKeyHash512 extends CFLibKeyHash512 implements ICFLibRequired, ICFLibReqKeyHash512 {
