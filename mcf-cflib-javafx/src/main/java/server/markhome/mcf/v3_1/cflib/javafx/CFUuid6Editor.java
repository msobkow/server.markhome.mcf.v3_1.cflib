...
extends CFTextField
{
	protected final static int MAX_LEN = ICFLibUuid6.STRING_LENGTH;
	...
	public void setUuid6Value( ICFLibUuid6 value ) {
		if( value != null ) {
	...
	public ICFLibUuid6 getUuid6Value() {
		...
		if( text == null || text.isEmpty() ) {
			...
			try {
				ICFLibUuid6 retval = CFLibUuid6.fromString(text);
				return( retval );
			}
			catch( Throwable th ) {
